...
def download_weights(phi, model_dir="./model_data"):
    ...
    # download_urls = {
    #     'b0': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b0_backbone_weights.pth",
    #     'b1': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b1_backbone_weights.pth",
    #     'b2': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b2_backbone_weights.pth",
    #     'b3': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b3_backbone_weights.pth",
    #     'b4': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b4_backbone_weights.pth",
    #     'b5': r"F:\ranXY\segformer-pytorch-master\model_data\segformer_b5_backbone_weights.pth",
    # }
...
#     import os
#     download_urls = {
#         'b0': "segformer_b0_backbone_weights.pth",
#         'b1': "segformer_b1_backbone_weights.pth",
#         'b2': "segformer_b2_backbone_weights.pth",
#         'b3': "segformer_b3_backbone_weights.pth",
#         'b4': "segformer_b4_backbone_weights.pth",
#         'b5': "segformer_b5_backbone_weights.pth",
#     }
#
#     if phi not in download_urls:
#         raise ValueError(f"Invalid phi value: {phi}")
#
#     weight_file = download_urls[phi]
